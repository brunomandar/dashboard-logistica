...
function carregarFiltrosProjetos() {
    ...
    fetch("https://dashboard-logistica-gn51.onrender.com/projetos")
...
function carregarDashboard() {
    ...
    // ✅ MÉTRICAS
    fetch(`https://dashboard-logistica-gn51.onrender.com/dashboard?gerente=${gerente}&forum=${forum}&status=${status}`)
    .then(res => res.json())
    .then(data => {
...
if (ctx) {
    ...
    window.grafico = new Chart(contexto, {
        ...
        fetch(`https://dashboard-logistica-gn51.onrender.com/projetos?gerente=${gerente}&forum=${forum}&status=${status}`)
        .then(res => res.json())
        .then(lista => {
...
function carregarFiltrosAcoes() {
    ...
    fetch("https://dashboard-logistica-gn51.onrender.com/acoes")	
    .then(res => res.json())
    .then(data => {
...
function carregarAcoes() {
    ...
    fetch(`https://dashboard-logistica-gn51.onrender.com/acoes?gerente=${gerente}&forum=${forum}`)
    .then(res => res.json())
    .then(data => {
